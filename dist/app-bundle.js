    ...
    function Scene(props) {
        ...
        _this.RenderCountdownScene = function () {
            fetch("api/GetRemainingTime")
                ...
                _this.setState({ RemainingTime: result.seconds });
                _this.setState({ component: React.createElement("div", { className: "with-flag" },
                        ...
                        React.createElement(ReactCountdownClock, { seconds: _this.state.RemainingTime, color: "#4fc3f7", alpha: 0.9, size: 500, onComplete: _this.RenderAnimationScene }))
                });
            }, function (error) {
                console.log(error);
            });
